...
$q_data = mysql_query("select * from menus where id_menu = '41'");
...
<form name="RTEDemo" method="post" enctype="multipart/form-data" action="admin/controller/faq.php?req=edit" class="form" onsubmit="return submitForm();">
