...
<form name="RTEDemo" method="post" enctype="multipart/form-data" action="admin/controller/ppid.php?req=edit&id_menu=<?php echo $_GET['id_menu'] ?>" class="form" onsubmit="return submitForm();">
