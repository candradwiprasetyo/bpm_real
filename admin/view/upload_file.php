...
<form name="form1" method="post" enctype="multipart/form-data" action="admin/controller/upload_file.php?req=edit" class="form">
  <table width="100%" border="0" cellspacing="0" cellpadding="2">
   <?php
    ...
    <tr>
      ...
      <td valign="top">
      <input type="file" name="gallery_file<?php echo $no; ?>" id="gallery_file<?php echo $no; ?>" /></td>
    </tr>
    <?php
	 $no++;
	}
...
$query = "SELECT count(*) FROM gallery a
 ...
 where gallery_type = '2' $where order by gallery_id DESC ";
 //echo $query;
...
while($b=mysql_fetch_array($result)){
   ...
   <tr <?php if($i%2==1){ echo "class='tr'"; }else{ echo "class='tr2'"; } ?> >
      ...
      <td  class="td">
       <?php echo "http://".$_SERVER['SERVER_NAME']."/bpm/".$b['gallery_url']?>
     
      
      </td>
      <td>   <a href="<?php echo $b['gallery_url'] ?>" title="Download"><div class="download"></div></a></td>
<td  class="td">
       
      <a href="javascript:void(0)" onclick="confirm_delete(<?php echo $b[0]; ?>,'admin/controller/upload_file.php?req=delete&gallery_id=')"><div class="trash"></div></a>
...
if ($pageno2 == 1) {
   ...
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/upload_file&pageno2=1'><div class=\"page_first\"></div></a> ";
   $prevpage = $pageno2-1;
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/upload_file&pageno2=$prevpage'><div class=\"page_prev\"></div> </a>";
} // if
...
if ($pageno2 == $lastpage) {
   ...
   $nextpage = $pageno2+1;
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/upload_file&pageno2=$nextpage'><div class=\"page_next\"></div></a> ";
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/upload_file&pageno2=$lastpage'><div class=\"page_last\"></div></a> ";
} 
