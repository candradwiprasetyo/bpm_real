...
<form name="form1" method="post" enctype="multipart/form-data" action="admin/controller/buku_biru_pic.php?req=save_all&publication_id=<?php echo $_GET['publication_id'] ?>" class="form">
