...
$q_data = mysql_query("select * from popup_home");
...
<form name="RTEDemo" method="post" enctype="multipart/form-data" action="admin/controller/popup_home.php?req=edit" class="form" onsubmit="return submitForm();">
