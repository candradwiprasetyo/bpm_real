...
$query = "select count(*) from news_menu a 
					...
					where b.level = '3' $where order by news_id desc  ";
...
$query = "select * from news_menu a 
					join menus b on b.id_menu = a.news_cat_id
					where b.level = '3' $where order by news_id desc $limit";
$result = mysql_query($query);
$i = 1;
while($b=mysql_fetch_array($result)){
    ...
    <tr <?php if($i%2 == 1){ ?>class="tr" <?php }else{ ?> class="tr2"<?php } ?>>
     ...
     <a href="admin.php?page=admin/view/news_menu_bidang&news_id=<?php echo $b[0] ?>"><div class="edit"></div></a>
...
if ($pageno2 == 1) {
   ...
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/news_menu_bidang&pageno2=1'><div class=\"page_first\"></div></a> ";
   $prevpage = $pageno2-1;
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/news_menu_bidang&pageno2=$prevpage'><div class=\"page_prev\"></div> </a>";
} // if
...
if ($pageno2 == $lastpage) {
   ...
   $nextpage = $pageno2+1;
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/news_menu_bidang&pageno2=$nextpage'><div class=\"page_next\"></div></a> ";
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/news_menu_bidang&pageno2=$lastpage'><div class=\"page_last\"></div></a> ";
} 
