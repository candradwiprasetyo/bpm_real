...
$query = "SELECT count(*) FROM album_pic where album_id = '".$_GET['album_id']."' $where order by pic_id DESC ";
...
$query = "SELECT * FROM album_pic where album_id = '".$_GET['album_id']."' $where order by pic_id DESC $limit";
$result = mysql_query($query);
$i = 1;
while($b=mysql_fetch_array($result)){
    ...
    <tr <?php if($i%2==1){ echo "class='tr'"; }else{ echo "class='tr2'"; } ?> >
     ...
     <a href="admin.php?page=admin/view/album_pic&album_id=<?php echo $_GET['album_id']?>&pic_id=<?php echo $b[0] ?>"><div class="edit"></div></a>
...
if ($pageno2 == 1) {
   ...
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/album_pic&album_id=$album_id&pageno2=1'><div class=\"page_first\"></div></a> ";
   $prevpage = $pageno2-1;
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/album_pic&album_id=$album_id&pageno2=$prevpage'><div class=\"page_prev\"></div> </a>";
} // if
...
if ($pageno2 == $lastpage) {
   ...
   $nextpage = $pageno2+1;
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/album_pic&album_id=$album_id&pageno2=$nextpage'><div class=\"page_next\"></div></a> ";
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/album_pic&album_id=$album_id&pageno2=$lastpage'><div class=\"page_last\"></div></a> ";
} 
