...
$q_data = mysql_query("select * from menus where id_menu = '40'");
...
<form name="RTEDemo" method="post" enctype="multipart/form-data" action="admin/controller/one_stop_service.php?req=edit" class="form" onsubmit="return submitForm();">
 <table width="100%" border="0" cellspacing="0" cellpadding="4">
    <tr>
      <td width="20%">Judul</td>
      <td><input name="name" type="text" id="name" value="<?php echo $go->name ?>" class="field" />
     </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
