...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="table">
    <tr class="judul">
      ...
      <td width="16%" height="30">Kab/Kota</td>
...
$query = "select count(*) from news_city $where order by news_date desc  ";
...
$query = "select * from news_city $where order by news_date desc $limit";
$result = mysql_query($query);
$i = 1;
while($b=mysql_fetch_array($result)){
    ...
    <tr <?php if($i%2 == 1){ ?>class="tr" <?php }else{ ?> class="tr2"<?php } ?>>
     ...
     <a href="admin.php?page=admin/view/news_city&news_id=<?php echo $b[0] ?>"><div class="edit"></div></a>
...
if ($pageno2 == 1) {
   ...
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/news_city&pageno2=1'><div class=\"page_first\"></div></a> ";
   $prevpage = $pageno2-1;
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/news_city&pageno2=$prevpage'><div class=\"page_prev\"></div> </a>";
} // if
...
if ($pageno2 == $lastpage) {
   ...
   $nextpage = $pageno2+1;
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/news_city&pageno2=$nextpage'><div class=\"page_next\"></div></a> ";
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/news_city&pageno2=$lastpage'><div class=\"page_last\"></div></a> ";
} 
