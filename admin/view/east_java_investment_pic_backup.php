...
<form name="form1" method="post" enctype="multipart/form-data" action="<?php if($_GET['pic_id']){ echo "admin/controller/east_java_investment_pic.php?req=edit&publication_id=$_GET[publication_id]&pic_id=$_GET[pic_id]"; }else{ echo "admin/controller/east_java_investment_pic.php?req=save&publication_id=$_GET[publication_id]"; } ?>" class="form">
...
while($b=mysql_fetch_array($result)){
    ...
    <tr <?php if($i%2==1){ echo "class='tr'"; }else{ echo "class='tr2'"; } ?> >
      ...
      <a href="javascript:void(0)" onclick="confirm_delete(<?php echo $b[0]; ?>,'admin/controller/east_java_investment_pic.php?req=delete&publication_id=<?php echo $_GET['publication_id']?>&pic_id=')"><div class="trash"></div></a>
     <a href="admin.php?page=admin/view/east_java_investment_pic&publication_id=<?php echo $_GET['publication_id']?>&pic_id=<?php echo $b[0] ?>"><div class="edit"></div></a>
...
if ($pageno2 == 1) {
   ...
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/east_java_investment_pic&publication_id=$publication_id&pageno2=1'><div class=\"page_first\"></div></a> ";
   $prevpage = $pageno2-1;
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/east_java_investment_pic&publication_id=$publication_id&pageno2=$prevpage'><div class=\"page_prev\"></div> </a>";
} // if
...
if ($pageno2 == $lastpage) {
   ...
   $nextpage = $pageno2+1;
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/east_java_investment_pic&publication_id=$publication_id&pageno2=$nextpage'><div class=\"page_next\"></div></a> ";
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view/east_java_investment_pic&publication_id=$publication_id&pageno2=$lastpage'><div class=\"page_last\"></div></a> ";
} 
