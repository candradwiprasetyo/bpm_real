...
<form name="RTEDemo" method="post" enctype="multipart/form-data" action="admin/controller/inbox.php?req=answer&id=<?php echo $_GET['id']; ?>" class="form" onsubmit="return submitForm();">
...
//-->
   ...
   <table>
    <tr>
     ...
     <a href="admin.php?page=admin/view/inbox_forward&id=<?php echo $_GET['id']; ?>"> <span class="button_new">Forward</span></a>
      </td>
    </tr>
