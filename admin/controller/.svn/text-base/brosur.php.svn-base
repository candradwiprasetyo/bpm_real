...
switch($req){
	...
	if($publication_title == "" || $publication_description == ""){
		header('Location: ../../admin.php?page=admin/view/brosur&add=1&err=1');
	}else{
	$Mysql->save("publications","('','$publication_title','$publication_description','$date', '3', '1')");
		header('Location: ../../admin.php?page=admin/view/brosur&did=1');
	}
	break;
	...
	if($publication_title == "" || $publication_description == ""){
		header("Location: ../../admin.php?page=admin/view/brosur&publication_id=$publication_id&err=1");
	}else{
		...
		header('Location: ../../admin.php?page=admin/view/brosur&did=2');
	}
	break;
	...
	header('Location: ../../admin.php?page=admin/view/brosur&did=3');
	...
	$publication_id = $_GET['publication_id'];
		...
		header('Location: ../../admin.php?page=admin/view/brosur&did=4');
	break;
	...
	$publication_id = $_GET['publication_id'];
		...
		header('Location: ../../admin.php?page=admin/view/brosur&did=5');
	break;
