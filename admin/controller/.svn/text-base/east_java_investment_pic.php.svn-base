...
switch($req){
	case add:
		...
		header("Location: ../../admin.php?page=admin/view/east_java_investment_pic_add_form&publication_id=$publication_id");
	break;
	...
	if($name1 == "" || $description1 == "" || $location1 == ""){
		header("Location: ../../admin.php?page=admin/view/east_java_investment_pic_add_form&publication_id=$publication_id&add=1&err=1");
	}else{
		...
		for($i=1; $i<=$jumlah; $i++){
			...
			header("Location: ../../admin.php?page=admin/view/east_java_investment_pic&publication_id=$publication_id&did=1");
		}
	}
	break;
	...
	if($name == "" || $description == "" || $location == ""){
		header("Location: ../../admin.php?page=admin/view/east_java_investment_pic&publication_id=$publication_id&add=1&err=1");
	}else{
	...
	$path = "img/img_publication/";
		...
		if($name == "" || $description == ""){
		header("Location: ../../admin.php?page=admin/view/east_java_investment_pic&publication_id=$publication_id&pic_id=$pic_id&err=1");
	}else{
		...
		header("Location: ../../admin.php?page=admin/view/east_java_investment_pic&publication_id=$publication_id&did=2");
	}
	break;
	...
	header("Location: ../../admin.php?page=admin/view/east_java_investment_pic&publication_id=$publication_id&did=3");
