...
switch($req){
	...
	if($publication_title == "" || $publication_description == ""){
		header('Location: ../../admin.php?page=admin/view/buku_biru&add=1&err=1');
	}else{
	$Mysql->save("publications","('','$publication_title','$publication_description','$date', '4', '1')");
		header('Location: ../../admin.php?page=admin/view/buku_biru&did=1');
	}
	break;
	...
	if($publication_title == "" || $publication_description == ""){
		header("Location: ../../admin.php?page=admin/view/buku_biru&publication_id=$publication_id&err=1");
	}else{
		...
		header('Location: ../../admin.php?page=admin/view/buku_biru&did=2');
	}
	break;
	...
	header('Location: ../../admin.php?page=admin/view/buku_biru&did=3');
	...
	$publication_id = $_GET['publication_id'];
		...
		header('Location: ../../admin.php?page=admin/view/buku_biru&did=4');
	...
	$publication_id = $_GET['publication_id'];
		...
		header('Location: ../../admin.php?page=admin/view/buku_biru&did=5');
	break;
