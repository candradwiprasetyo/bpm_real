...
$query = "select count(*) from contact_questions order by tgl desc ";
...
$query = "select * from contact_questions order by tgl desc $limit";
$result = mysql_query($query);
$i = 1;
while($b=mysql_fetch_array($result)){
    ...
    <tr  <?php if($i%2==1){ ?>class="tr"<?php }else{ ?> class="tr2"<?php } ?>>
      ...
      <?php if($b['status'] == 1){?>
     <a href="admin.php?page=admin/view_new/inbox_form&id=<?php echo $b[0] ?>"><div class="edit"></div></a>
     <?php
	  }
	 ?>
...
if ($pageno2 == 1) {
   ...
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view_new/inbox&pageno2=1'><div class=\"page\"> FIRST</div></a> ";
   $prevpage = $pageno2-1;
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view_new/inbox&pageno2=$prevpage'><div class=\"page\"> PREV</div> </a>";
} // if
...
if ($pageno2 == $lastpage) {
   ...
   $nextpage = $pageno2+1;
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view_new/inbox&pageno2=$nextpage'><div class=\"page\"> NEXT</div></a> ";
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view_new/inbox&pageno2=$lastpage'><div class=\"page\"> LAST</div></a> ";
} 
