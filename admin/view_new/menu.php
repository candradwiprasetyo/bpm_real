...
while($b=mysql_fetch_array($result)){
    ...
    <tr <?php if($i%2==1){ echo "class='tr'"; }else{ echo "class='tr2'"; } ?>>
     ...
     <a href="admin.php?page=admin/view_new/menu&news_id=<?php echo $b[0] ?>"><div class="edit"></div></a>
...
if ($pageno2 == 1) {
   ...
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view_new/menu&pageno2=1'><div class=\"page\"> FIRST</div></a> ";
   $prevpage = $pageno2-1;
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view_new/menu&pageno2=$prevpage'><div class=\"page\"> PREV</div> </a>";
} // if
...
if ($pageno2 == $lastpage) {
   ...
   $nextpage = $pageno2+1;
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view_new/menu&pageno2=$nextpage'><div class=\"page\"> NEXT</div></a> ";
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view_new/menu&pageno2=$lastpage'><div class=\"page\"> LAST</div></a> ";
} 
