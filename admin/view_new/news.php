...
$kategori = array(0=>'Kinerja Investasi', 1=>'Potensi Investasi',2=>'Berita',3=>'Agenda Kegitan',4=>'Peraturan Terkait'); # jangan lupa set up variabel $x untuk memunculkan datanya
...
<table width="100%" border="0" cellspacing="4" cellpadding="0" class="table">
    <tr>
      <td width="7%" height="30">No</td>
         <td width="22%" height="30">Kategori</td>
...
if ($pageno2 == 1) {
   ...
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view_new/news&pageno2=1'><div class=\"page\"> FIRST</div></a> ";
   $prevpage = $pageno2-1;
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view_new/news&pageno2=$prevpage'><div class=\"page\"> PREV</div> </a>";
} // if
...
if ($pageno2 == $lastpage) {
   ...
   $nextpage = $pageno2+1;
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view_new/news&pageno2=$nextpage'><div class=\"page\"> NEXT</div></a> ";
   echo "<a href='{$_SERVER['PHP_SELF']}?page=admin/view_new/news&pageno2=$lastpage'><div class=\"page\"> LAST</div></a> ";
} 
