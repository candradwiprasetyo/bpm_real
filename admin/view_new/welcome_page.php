...
<form name="RTEDemo" method="post" enctype="multipart/form-data" action="admin/controller/welcome_page.php?req=edit" class="form" onsubmit="return submitForm();">
 <table width="800" border="0" cellspacing="0" cellpadding="4">
    <tr>
      <td width="20%">Judul</td>
      <td><input name="welcome_page_name" type="text" id="welcome_page_name" value="<?php echo $go->welcome_page_name ?>" class="field" />
     </td>
    </tr>
     <tr>
      <td>Foto</td>
      ...
      <img src="<?php echo $go->welcome_page_photo ?>" height="100" /><br />
