...
$query = "select count(*) from news_city where news_id <> 0 $cat order by news_date desc  ";
...
$query = "select * from news_city where news_id <> 0 $cat order by news_date desc $limit";
$result = mysql_query($query);
$i = 1;
while($b=mysql_fetch_array($result)){
    ...
    <tr <?php if($i%2 == 1){ ?>class="tr" <?php }else{ ?> class="tr2"<?php } ?>>
     ...
     <a href="admin.php?page=admin/view_new/news_city2&news_id=<?php echo $b[0] ?>"><div class="edit"></div></a>
