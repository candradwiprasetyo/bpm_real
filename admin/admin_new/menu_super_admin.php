  ...
  <tr>
    ...
    <?php } ?></td>
      ...
      <a href="admin.php?page=admin/view/one_stop_service" style="text-decoration:none;"><div class="fpanela" >One Stop Service</div></a>
       <a href="admin.php?page=admin/view/faq" style="text-decoration:none;"><div class="fpanela" >FAQ</div></a>
  		<?php /*<a href="admin.php?page=admin/view/peraturan_terkait" style="text-decoration:none;"><div class="fpanela" >Peraturan Terkait</div></a> */ ?>
	...
	*/ ?>
    ...
    <div class="AccordionPanel">
      ...
      <div class="AccordionPanelContent">
      <a href="admin.php?page=admin/view/user" style="text-decoration:none"><div class="fpanela" >User</div></a>
   <a href="admin.php?page=admin/view/user_types" style="text-decoration:none"> <div class="fpanela" >Tipe User</div></a>
     <a href="admin.php?page=admin/view/hak_akses" style="text-decoration:none"><div class="fpanela" >Hak Akses</div></a>
